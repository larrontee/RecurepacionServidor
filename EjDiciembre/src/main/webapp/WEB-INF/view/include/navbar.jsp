...
<nav id="navbar_top"
	...
	<a class="navbar-brand" href="${proyecto }/Home"><fmt:message
			key="home" /></a>
		...
		<ul class="navbar-nav mr-auto">
			<c:choose>
				...
				<c:when test="${rol == 'admin'}">
					...
					<a href="admin/addProduct"></a>
					</li>
					<li class="nav-item active"><a class="nav-link"
						href="${proyecto }/Admin/AddEmpleado"><fmt:message key="insert" /> <fmt:message
								key="employee" /></a></li>
					<fmt:message key="zadm" />


				</c:when>
			</c:choose>
			<li class="nav-item active right"><a class="nav-link"
				href="Logout"><fmt:message key="logout" /><br />(${rol })</a></li>
		</ul>
	</div>
</nav>
